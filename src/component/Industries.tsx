        ...
        <div className="industryapllContainer">
          <div className="industryappBox">
            ...
            <div className="industryDes">
              ...
              <p>
                High‑purity ingredients, API intermediates, and regulatory‑grade
                chemical solutions for pharma manufacturing.
              </p>
            </div>
          </div>
          <div className="industryappBox">
            ...
            <div className="industryDes">
              ...
              <p>
                Food‑grade additives, preservatives, stabilizers, and compliant
                ingredients for safe production.
              </p>
            </div>
          </div>
          <div className="industryappBox">
