    ...
    <>
      ...
      <div className="Storysectiton">
        <div className="storycona">
          <h1>Our Story</h1>
          <p>
            We began with a mission to deliver reliable, high-quality chemical
            and industrial powders to businesses across pharmaceutical, food,
            and industrial sectors. Over the years, we have expanded our
            capabilities, upgraded our manufacturing technologies, and built a
            strong reputation for consistency, technical expertise, and
            customer-first service.
            <br />
            Our approach blends scientific rigour with operational excellence —
            from R&D to scale-up — ensuring our partners receive safe,
            compliant, and high-performance materials.
          </p>
        </div>
        ...
        <div className="ourseccontainer">
          ...
          <div className="oursecbox">
            ...
            <div className="oursecminbox">
              <h3>Expansion</h3>
              <p>
                Increased product portfolio and QC capabilities to serve wider
                industries.
              </p>
            </div>
          </div>
      ...
      <div className="Visionsection">
        ...
        <p>
          Our guiding principles define how we operate, innovate, and partner
          with customers.
        </p>
        <div className="visoncont">
          <div className="visonBox">
            ...
            <p>
              Deliver high-quality, compliant, and reliable chemical products
              that support safe and efficient industrial processes.
            </p>
          </div>
          <div className="visonBox">
            <h3>
            ...
            <p>
              To become a global leader in innovative and sustainable chemical
              manufacturing.
            </p>
          </div>
          <div className="visonBox">
      ...
      <div className="Exploreproductsection">
        ...
        <p>
          Our technical sales team can provide specification sheets, samples,
          and custom formulation guidance.
        </p>
        <div className="Hubconx">
          <p>
